...
$sql = "SELECT * FROM appointments WHERE patientName = '$username' ";
    ...
    <header>
        ...
        <nav class="navbar  navbar-expand-md navbar-light bg-light m-0 p-0">
            ...
            <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="UserPage.php?username=<?php echo $username; ?>"><strong>Doctor
                                    Schedule</strong></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            if ($row['status'] == 'yes') {
                                ...
                                echo '<td>';
                                echo '<a class="btn btn-outline-primary btn-block fa-lg" type="button" href="PrescriptionPdf.php?username=' . urlencode($username) . '">Generate PDF</a>';
                                echo '</td>';
                                echo "</tr>";
                                $counter++;
                            }
